...
public static class Modelattack_titan extends AnimatedEntityModel {
	...
	public Modelattack_titan() {
		...
		rshoulderarm.setTextureOffset(148, 102).addBox(-36.2344F, -127.5436F, -3.1025F, 3.0F, 33.0F, 15.0F, 0.0F,
				false);
		...
		rshoulderarm.setTextureOffset(151, 171).addBox(-58.1431F, -122.2539F, -1.6025F, 3.0F, 21.0F, 12.0F, 0.0F,
				false);
		...
		rihgtlowerlegs.setTextureOffset(131, 155).addBox(-15.5822F, -20.2598F, -4.1972F, 18.0F, 39.0F, 3.0F, 0.0F,
				false);
		rihgtlowerlegs.setTextureOffset(128, 90).addBox(-17.4266F, -25.5098F, -3.1025F, 21.0F, 9.0F, 15.0F, 0.0F,
				false);
		rihgtlowerlegs.setTextureOffset(116, 0).addBox(-17.4266F, -37.5098F, -6.1025F, 21.0F, 12.0F, 18.0F, 0.0F,
				false);
		rihgtlowerlegs.setTextureOffset(92, 2).addBox(-17.4266F, -16.5098F, -3.1025F, 21.0F, 27.0F, 15.0F, 0.0F, false);
		rihgtlowerlegs.setTextureOffset(86, 145).addBox(-15.5822F, -21.7598F, 10.0327F, 18.0F, 45.0F, 3.0F, 0.0F,
				false);
