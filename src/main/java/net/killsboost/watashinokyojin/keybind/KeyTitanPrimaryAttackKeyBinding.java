...
public class KeyTitanPrimaryAttackKeyBinding extends MyTitanModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public KeyTitanPrimaryAttackKeyBinding(MyTitanModElements instance) {
		super(instance, 56);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.key_titan_primary_attack", GLFW.GLFW_KEY_R, "key.categories.aom");
