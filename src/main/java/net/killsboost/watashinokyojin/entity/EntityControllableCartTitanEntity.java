...
import net.killsboost.watashinokyojin.procedures.EntityControllableCartTitanRightClickedOnEntityProcedure;
...
public class EntityControllableCartTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = null;
	public EntityControllableCartTitanEntity(MyTitanModElements instance) {
		super(instance, 49);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.9f, 1.4f))
						.build("entity_controllable_cart_titan").setRegistryName("entity_controllable_cart_titan");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -256, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("entity_controllable_cart_titan_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IAnimatedEntity {
		...
		public boolean processInteract(PlayerEntity sourceentity, Hand hand) {
				...
				if (sourceentity instanceof ServerPlayerEntity) {
					NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("Cart Titan");
						}
						...
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							...
							return new CartTitanGUIGui.GuiContainerMod(id, inventory, packetBuffer);
						}
					}, buf -> {
			...
			Entity entity = this;
			{
				...
				EntityControllableCartTitanRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
