...
public class EntityControllableArmoredTitanEntity extends MyTitanModElements.ModElement {
	public static EntityType entity = null;
	public EntityControllableArmoredTitanEntity(MyTitanModElements instance) {
		super(instance, 58);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("entity_controllable_armored_titan").setRegistryName("entity_controllable_armored_titan");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -154, -52429, new Item.Properties().group(CreativeTabMyTitanItemGroup.tab))
				.setRegistryName("entity_controllable_armored_titan_spawn_egg"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("my_titan:textures/cartgui.png");
				}
			};
